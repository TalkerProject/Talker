...
class ChatLogController : UICollectionViewController, UITextFieldDelegate, UICollectionViewDelegateFlowLayout, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    var user : User? {
        didSet {
            ...
            let videoCall : UIBarButtonItem = UIBarButtonItem(title: "Video Call", style: UIBarButtonItemStyle.plain, target: self, action: #selector(ChatLogController.videoCallButtonClicked))
